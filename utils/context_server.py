...
from strategies.order_flow import get_obi_signal

class MarketContextServer:
    """
    Centralized 'MCP-style' context aggregator.
    Compresses technicals, news, OBI, and cross-asset data into an LLM-optimized feed.
    """
    def __init__(self):
    ...
    async def get_compressed_context(self, coins=["BTC", "ETH"]):
        ...
        """
        # 1. Gather Crypto Technicals + OBI
        crypto_data = {}
        for coin in coins:
